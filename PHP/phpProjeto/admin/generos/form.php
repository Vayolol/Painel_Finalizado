<?php
  ...
  if(isset($_GET['id'])&& is_numeric($_GET['id'])){
    ...
    // preparação da consulta no back-end
     ...
     // endpoint da API
     $end_point = "http://localhost/api_jornal/generos/?id=$id";
     ...
     $arrGeneros = $dado["generos"];
 
     if ($dado['status'] =='success'){
      $tipo_genero = $arrGeneros['tipo_genero'];
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inserir Generos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">  
                      <label for="tipo_genero">Tipo Genero</label>
                      <input type="text" id="tipo_genero" name="tipo_genero" value="<?php  echo $tipo_genero?>" class="form-control" placeholder="Tipo Genero" >
                    </div>
                  </div>
